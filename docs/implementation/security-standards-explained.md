...
This document explains our implementation of the **FAPI 2.0 Security Profile** for the Swiss Open API Customer Relationship project. If you're not very familiar with coding and new to API security standards, this guide will help you understand what we've built and why each component is important.
