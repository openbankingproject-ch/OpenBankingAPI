...
## Swiss Context and Project-Specific Sources

**Primary Project Source:**
- **Open Banking Project Overall Document** - Comprehensive Workshop Findings and Project Documentation (2024/2025)
  - Central source for all Use Cases, API Specifications, Architectural Models
  - Workshop-based expert opinions and market analysis
  - Regulatory questions and Compliance Framework development
  - Technical Specifications for FAPI 2.0 Implementation

**FINMA and Swiss Regulation:**
- FINMA Circular RS 2008/7 "Outsourcing Banks"
- FINMA Circular RS 2016/7 "Video and Online Identification"
- Swiss Banking Act (BankG) - Art. 47 Banking Secrecy
- Anti-Money Laundering Act (GwG) - Art. 3, 4 Identification Duties
- Data Protection Act (FADP) - 2023 Revision with GDPR Equivalence
- Basel Committee on Banking Supervision - Basel III/IV Implementation

**E-ID Integration and Swiss Infrastructure:**
- Federal Act on Electronic Identity Services (E-ID Act)
...
- Federal Chancellery - "Building Blocks of Data Spaces – Data Ecosystem Switzerland"
...
- W3C Standards - Web APIs and Authentication Patterns
...
- Brasil Open Finance - Technical Specifications and Governance Framework
- Australia Consumer Data Right (CDR) - Standards and Compliance Guidelines
- Singapore Account Information Service (AIS) - MAS Implementation Guide

## Market Analysis and Business Intelligence Sources
...
- Code of Obligations (OR) - Art. 41 Liability for Tort
- Banking Ordinance (BankV) - Art. 25 Outsourcing Provisions
- GwG Ordinance FINMA (GwV-FINMA) - Art. 28 Prohibition of Further Delegation
- Ordinance on the Supervision of Banks (VSB) - Art. 19 Group Regulation
- Federal Act on Data Protection (FADP) - 2023 Revision
...
- Vigi Trust AG - Independent Legal Assessment for Open Banking
- Baker McKenzie Zurich - FinTech Regulatory Expertise
- Homburger AG - Banking and Finance Legal Practice
- CMS von Erlach Poncet - Technology and Data Protection Law
...
**Monitoring and Research Channels:**
- FINMA Communication and Regulatory Updates
- OpenID Foundation Standards Development
- OWASP Project Updates and Security Advisories
- European Banking Authority (EBA) Technical Standards
- Bank for International Settlements Innovation Publications

**Expert Network and Advisory Sources:**
...
**Note:** This collection of sources is continuously updated to reflect new standards, regulations, and best practices. All URLs and references were verified at the time of the last update.
